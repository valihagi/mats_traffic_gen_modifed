...
from cat.advgen.regret_level_generator import RegretMaximizingLevelGenerator
...
if __name__ == "__main__":
    ...
    adv_generator = RegretMaximizingLevelGenerator(parser)
    args = parser.parse_args()

    file_name = args.mode
    logger = SafeLogger(exp_name=args.mode, env_name=args.env, seed=args.seed,
                        fieldnames=['route_completion_normal', 'crash_rate_normal',
                                    'route_completion_adv', 'crash_rate_adv'])
