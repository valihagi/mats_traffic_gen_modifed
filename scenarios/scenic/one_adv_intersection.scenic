...
param map = localPath('../maps/Town10HD.xodr')  # or other CARLA map that definitely works
param carla_map = 'Town10HD'
model scenic.simulators.carla.model

DISTANCE_TO_INTERSECTION_ADV = -8
DISTANCE_TO_INTERSECTION_EGO = -8
NUM_VEHICLES = 2
...
ego = RouteFollowingCar following roadDirection from maneuver.startLane.centerline[-1] for DISTANCE_TO_INTERSECTION_EGO,
    with route route,
